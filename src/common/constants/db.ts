...
export const campaigns: AppCampaign[] = [
  ...
  } as AppCampaign,
  {
    ...
    disclaimer:
      'To participate, you must register your address in advance. Any attempt to artificially inflate transaction counts through automated means may result in disqualification. We reserve the right to determine what constitutes fair participation. Of the total contributions, 20% is reserved for the amendment developer, and 30% is allocated for bugs found during testing. If no bugs are discovered, this 30% will be distributed among the testers. By contributing, you agree to these terms and conditions.',
